...
router.post("/", authentication, authorization('Quản trị viên'), CreateAnUserValidator, validatedResult, async function (req, res, next) {
  try {
...
router.put("/:id", authentication, authorization('Quản trị viên'), ModifyAnUser, validatedResult, async function (req, res, next) {
  try {
